<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"F:\www\Tp_try\think\public/../application/index\view\article\article.html";i:1508506787;s:69:"F:\www\Tp_try\think\public/../application/index\view\common\head.html";i:1508326876;s:70:"F:\www\Tp_try\think\public/../application/index\view\common\right.html";i:1508651419;s:71:"F:\www\Tp_try\think\public/../application/index\view\common\footer.html";i:1507639668;}*/ ?>
                ...
                <div class="xgread">
                    ...
                    <div class="rig">
                        <ul>
                            ...
                            <li><a href='./images/20160907155021.html' target="_blank"><?php echo $vo['1']; ?></a></li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                    ...
                    <ul>
                        ...
                        <li>
                          ...
                          " alt="<?php echo $vo['title']; ?>"/>
                            ...
                            <p><a href='./images/20160920156214.html'><?php echo $vo['title']; ?></a></p></li>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>		
            </div>
...
<li class="hm-t-item hm-t-item-img"><a data-pos="0" title="<?php echo $vo['title']; ?>" target="_blank" href="<?php echo url('article/index',array('arid' => $vo['id'])); ?>" class="hm-t-img-title" style="visibility: visible;"><span><?php echo $vo['title']; ?></span></a></li>
<?php endforeach; endif; else: echo "" ;endif; ?>
...
<li class="hm-t-item hm-t-item-img"><a style="visibility: visible;" class="hm-t-img-title" href="<?php echo url('article/index',array('arid' => $vo['id'])); ?>" target="_blank" title="<?php echo $vo['title']; ?>" data-pos="0"><span><?php echo $vo['title']; ?></span></a></li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
</div></div></div>
